    ...
    return BlocBuilder<ProductsCubit, ProductsState>(
      builder: (context, state) {
        if (state is ProductsLoading) {
          ...
          if (state.propertyProducts.isEmpty) {
            return const Center(
              child: Text(
                'No property products available',
          ...
          return GridView.builder(
            ...
            itemCount: state.propertyProducts.length,
            itemBuilder: (context, index) {
              return ProductCard(product: state.propertyProducts[index]);
            },
          );
        }
